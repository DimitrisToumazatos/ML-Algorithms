...
sizePosTrainTest = dfPos.shape[0]                                  # shape[0] contains the number of rows of our file

for i in range(sizePosTrainTest):
...
for k in list1:
    ...
    for i in range(sizePosTrainTest, sizeNegTest+sizePosTrainTest):
        if y_pred[i] == 0:
            trueNegative += 1

    falsePositive = sizeNegTest - trueNegative
    falseNegative = sizePosTrainTest - truePositive

    # print test statistics
    print("Naive bayes statistics for " + str(sizeNegTrain + sizePosTrain) + " train examples, predicting the test data, are the following:")
    print("True Positive: " + str(truePositive))
    print("False Positive: " + str(falsePositive))
    print("True Negative: " + str(trueNegative))
    print("False Negative: " + str(falseNegative))
    print("The accuracy for the positive data is: " + str(round(((truePositive/sizePosTrainTest)), 3)))
    print("The accuracy for the negative data is: " + str(round(((trueNegative/sizeNegTest)), 3)))
    print("The total accuracy is: " + str(round((((trueNegative + truePositive)/(sizeNegTest + sizePosTrainTest))), 3)))  
    ...
    print("Naive bayes statistics for " + str(sizeNegTrain + sizePosTrain) + " train examples, predicting the train data, are the following:")
    print("True Positive: " + str(truePositive))
    print("False Positive: " + str(falsePositive))
    print("True Negative: " + str(trueNegative))
    print("False Negative: " + str(falseNegative))
    ...
    # print test statistics
    print("Random Forest statistics for " + str(sizeNegTrain + sizePosTrain) + " train examples, predicting the test data, are the following:")
    print("True Positive: " + str(truePositive))
    print("False Positive: " + str(falsePositive))
    print("True Negative: " + str(trueNegative))
    print("False Negative: " + str(falseNegative))
    ...
    # print train statistics
    print("Random Forest statistics for " + str(sizeNegTrain + sizePosTrain) + " train examples, predicting the train data, are the following:")
    print("True Positive: " + str(truePositive))
    print("False Positive: " + str(falsePositive))
    print("True Negative: " + str(trueNegative))
    print("False Negative: " + str(falseNegative))
    ...
    # print test statistics
    print("AdaBoost statistics for " + str(sizeNegTrain + sizePosTrain) + " train examples, predicting the test data, are the following:")
    print("True Positive: " + str(truePositive))
    print("False Positive: " + str(falsePositive))
    print("True Negative: " + str(trueNegative))
    print("False Negative: " + str(falseNegative))
    ...
    # print train statistics
    print("AdaBoost statistics for " + str(sizeNegTrain + sizePosTrain) + " train examples, predicting the train data, are the following:")
    print("True Positive: " + str(truePositive))
    print("False Positive: " + str(falsePositive))
    print("True Negative: " + str(trueNegative))
    print("False Negative: " + str(falseNegative))
